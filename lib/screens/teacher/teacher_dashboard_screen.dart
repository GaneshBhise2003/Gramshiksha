...
//                     '/login', // 🔹 Change this to your actual login route name
//                     (route) => false,
//                   );
//                 }
//               }
...
//               future: _getAttendanceSpots(teacher, databaseService),
//               builder: (context, snapshot) {
//                 final spots =
//                     snapshot.data ??
//                     [
...
//       // Calculate stats from all classes the teacher teaches
//       for (final classId in teacher.classIds) {
//         // Get students in this class (assuming classId is actually divisionId)
//         final students =
...
//       // Get recent assignments from all teacher's classes
//       for (final classId in teacher.classIds) {
//         final assignments =
//             await databaseService.getAssignmentsByDivision(classId).first;
//         final recentAssignments = assignments.take(2).toList();

//         for (final assignment in recentAssignments) {
//           activities.add({
//             'title':
//                 'Assignment "${assignment.title}" is available for submission',
//             'time': _getTimeAgo(assignment.createdAt),
//             'icon': Icons.assignment,
//           });
//         }
...
//             'time': _getTimeAgo(announcement.createdAt),
//             'icon': Icons.campaign,
//           });
//         }
//       }
...
//       // Get assignments with upcoming due dates from all teacher's classes
//       for (final classId in teacher.classIds) {
//         final assignments =
//             await databaseService.getAssignmentsByDivision(classId).first;
...
//             final daysDifference = assignment.dueDate.difference(now).inDays;
...
//         // Get quizzes that need review
//         final quizzes =
//             await databaseService.getQuizzesByDivision(classId).first;
//         for (final quiz in quizzes.take(2)) {
//           tasks.add({
//             'title': 'Review quiz: "${quiz.title}"',
//             'dueDate': 'Ongoing',
//             'color': Colors.blue,
//             'isUrgent': false,
//           });
...
//   Future<List<FlSpot>> _getAttendanceSpots(
//     TeacherModel teacher,
//     DatabaseService databaseService,
//   ) async {
//     try {
...
//       // For now, generate simulated attendance data
//       // TODO: Implement actual attendance data calculation when attendance system is complete
//       final baseRate = 85.0;
//       for (int i = 0; i < 7; i++) {
//         final variation = (i % 2 == 0 ? 1 : -1) * (i * 2.0);
//         final rate = (baseRate + variation).clamp(70.0, 95.0);
...
//           : spots;
//     } catch (e) {
//       print('Error getting attendance spots: $e');
